...
function NewPageModule({
 ...
 <Link href={getText(settings, "buttonHref", "/catalog?new=1")} className={`rounded-xl border px-6 py-3 text-sm font-medium ${dark ? "border-white/10 bg-white/[0.035]" : "border-black/10 bg-white "}`}>
